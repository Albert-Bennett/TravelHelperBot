...
namespace TravelHelper
{
    ...
    /// </summary>
    public class TravelHelperAccessors
    {
        /// <summary>
        ...
        public TravelHelperAccessors(ConversationState conversationState)
        {
        ...
        public static string CounterStateName { get; } = $"{nameof(TravelHelperAccessors)}.CounterState";
